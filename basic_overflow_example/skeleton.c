...
MODULE_DESCRIPTION ("Kernel module exploit example, simple buffer overflow");

/* This module demonstrates a how objects in memory can be overwritten without sufficient checks 
 * These structures may be used in decision making at a later point for priviledged operations
 */


#define BUFFERSIZE 1

static ssize_t exploitable_write(struct file *file,const char *buf, size_t len, loff_t *off);
